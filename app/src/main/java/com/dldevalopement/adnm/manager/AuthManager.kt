...
class AuthManager {
    ...
    companion object {
        ...
        fun logout(context: Context) {
            // Build and show a confirmation dialog using Material Components
            val dialog = MaterialAlertDialogBuilder(context, R.style.dialog)
                ...
                .setPositiveButton(context.getString(R.string.yes)) { _, _ ->
                    ...
                    // Show a progress dialog while waiting for server response
                                ...
                                .addOnCompleteListener { task ->
                                    ...
                                    FirebaseMessaging.getInstance()
                                        ...
                                        .addOnCompleteListener {
                                            ...
                                            // Finish the current activity if the context is an instance of Activity
            ...
            // Customize the button colors after the dialog is shown to match the app theme
